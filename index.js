...
class SuperJSONCarousel extends Carousel {
  ...
  renderButton(args) {
    ...
    let {content, css, title, data} = args;
  ...
  renderAutoControls() {
    ...
    // Set up button options as objects.
    const playBtnOptions = {
      content: "Play",
      css: "button button--play"
    }
    const pauseBtnOptions = {
      content: "Pause",
      css: "button button--pause"
    }
    return [
      this.renderButton(playBtnOptions),
      this.renderButton(pauseBtnOptions)
    ].join("");
  }
   ...
   */
  renderButtons() {
    const prevBtnOptions = {
      content: "&#10094;",
      css: "button button--prev",
      title: "Prev",
      data: "prev"
    }
    const nextBtnOptions = {
      content: "&#10095;",
      css: "button button--next",
      title: "Next",
      data: "next"
    }
    return [
      this.renderPager(),
      this.renderButton(prevBtnOptions),
      this.renderAutoControls(),
      this.renderButton(nextBtnOptions)
    ].join("");
  }
